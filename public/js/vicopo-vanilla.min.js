(function (w) {
    ...
    var methods = {
        each: function (callback) {
            ...
            return this.nodes.length > 0 && this.nodes[0] && (" " + this.nodes[0].className + " ").indexOf(" " + className + " ") !== -1
            ...
            return this.val(_pattern.replace(/(city|ville)/gi, _city).replace(/(zipcode|code([\s_-]?postal)?)/gi, _code)).vicopoTargets().vicopoClean()
    ...
    function checkValue(element) {
        ...
        if ($target.data("vicopo-value") !== _input) {
            ...
            var _$targets = $target.data("vicopo-value", _input).vicopoTargets().each(function (elt) {
...
})(typeof globalThis !== "undefined" && globalThis || typeof self !== "undefined" && self || typeof global !== "undefined" && global || typeof window !== "undefined" && window || {});
